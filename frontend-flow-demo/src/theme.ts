...
export const ROUTE_COLORS: Record<string, { base: string; glow: string; label: string; cn: string }> = {
  ...
  autonomous: { base: "#f59e0b", glow: "#fbbf24", label: "AUTONOMOUS", cn: "自主探索 Loop" },
  exploration: { base: "#f59e0b", glow: "#fbbf24", label: "EXPLORATION", cn: "多算法融合" },
};
...
export const PHASES: PhaseDef[] = [
  // 收敛为 4 色族:青绿(观测/评估)·青(采集/匹配/推理)·琥珀(检测/恢复)·绿(恢复完成)
  { id: 0, key: "idle", cn: "网络就绪", en: "STEADY STATE", color: "#2dd4bf", glow: "#5eead4" },
  ...
  { id: 3, key: "confidence", cn: "策略匹配", en: "POLICY MATCHING", color: "#38bdf8", glow: "#7dd3fc" },
  { id: 4, key: "reasoning", cn: "根因推理", en: "AGENT 2 · REASONING", color: "#38bdf8", glow: "#7dd3fc" },
  { id: 5, key: "recovery", cn: "执行恢复", en: "RECOVERY ACTION", color: "#f59e0b", glow: "#fbbf24" },
  { id: 6, key: "healed", cn: "网络恢复", en: "NETWORK HEALED", color: "#22c55e", glow: "#4ade80" },
